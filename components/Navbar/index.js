  ...
  return (
    <>
      <div className="mr-4 text-center lg:text-center">
        ...
        <button className="bg-white hover:bg-gray-100 text-gray-800 font-semibold py-2 px-4 border border-gray-400 rounded-full shadow mx-5">
          <Link href="/auth/films">films</Link>
        </button>

        <button className="bg-white hover:bg-gray-100 text-gray-800 font-semibold py-2 px-4 border border-gray-400 rounded-full shadow mx-5">
          <Link href="/auth/saved">saved</Link>
        </button>

        <button className="bg-white hover:bg-gray-100 text-gray-800 font-semibold py-2 px-4 border border-gray-400 rounded-full shadow mx-5">
          <Link href="/auth/logs">logs</Link>
        </button>
      </div>
    </>
  );
...
const Navbar = () => {
  ...
  if (status === "authenticated") {
    const [image, username] = [session.user.image, session.user.name];
          ...
          <div className="grid grid-cols-2">
            ...
            <div className="text-lg text-right col-start-5">
              ...
              <div className="text-lg font-bold ">
                <Link href="/auth/account">{username.split(" ")[0]}</Link>
              </div>
              <a
